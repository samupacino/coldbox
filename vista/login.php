	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('src_login/images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form action="index.php?columna" method="POST" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="password" placeholder="Password" value="admin123">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
